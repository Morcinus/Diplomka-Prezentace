...
\begin{itemize}
    \item Důvody vzniku projektu
    \begin{itemize}
        \item Snadnost učení % v autobuse atd.
        \item Forma učení % krátká videa se cvičeními
...
\item Návrh prototypu uživatelského rozhraní
...
\begin{itemize}
    ...
    \item Vybrané funkce
    \begin{itemize}
        \item Interaktivní forma učení
        \item PWA
        \item Notifikace
        \item Žebříčky uživatelů
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Komponenty a funkce
        \item Funkce v testovacím prostředí
    \end{itemize}
