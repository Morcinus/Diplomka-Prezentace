...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Notifikace, studijní plány, doporučování obsahu, certifikáty, animace, statistiky o učení, opakování látky a další
        \item PWA
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Využití mock API pro rychlejší testování
    \end{itemize}
